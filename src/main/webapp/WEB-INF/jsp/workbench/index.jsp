...
<script type="text/javascript">
	...
	$(function(){
		...
		//在jsp页面中无法直接跳转到WEB-INF下的jsp页面(工作台的页面)，需要先跳转到controller，在controller中进行跳转
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='workbench/user/loginOut.do';">确定</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<%--需要先跳转到controller页面，然后在页面中进行跳转--%>
						<li><a href="settrings/settringsIndex.do"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<%--先跳转到controller页面，然后在跳转到显示的页面--%>
				<li class="liClass"><a href="workbeach/activity/toActivityIndex.do" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
				<%--这里我们也需要跳转到我们后台页面后，再跳转回我们显示的jsp页面--%>
				...
				<li class="liClass"><a href="" target="workareaFrame"><span class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
				<%--发送请求到后台进行跳转--%>
				<li class="liClass"><a href="workbench/transaction/toTransaction.do" target="workareaFrame"><span class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
